...
fun booleanOrDefault(default: Boolean): SharedPreferencesProperty<Boolean> = DefaultSharedPreferencesProperty(
...
fun booleanOrDefault(key: String, default: Boolean): SharedPreferencesProperty<Boolean> = DefaultSharedPreferencesProperty(
        getValue = LegacySharedPreferencesValue(SharedPreferences::getBoolean, Editor::putBoolean, key),
        setValue = Editor::putBoolean,
        default = default
)

fun floatOrDefault(default: Float): SharedPreferencesProperty<Float> = DefaultSharedPreferencesProperty(
...
fun floatOrDefault(key: String, default: Float): SharedPreferencesProperty<Float> = DefaultSharedPreferencesProperty(
...
fun intOrDefault(key: String, default: Int): SharedPreferencesProperty<Int> = DefaultSharedPreferencesProperty(
        getValue = LegacySharedPreferencesValue(SharedPreferences::getInt, Editor::putInt, key),
        setValue = Editor::putInt,
        default = default
)

fun longOrDefault(default: Long): SharedPreferencesProperty<Long> = DefaultSharedPreferencesProperty(
...
fun longOrDefault(key: String, default: Long): SharedPreferencesProperty<Long> = DefaultSharedPreferencesProperty(
...
fun stringOrDefault(default: String): SharedPreferencesProperty<String> = NullableSharedPreferencesProperty(
        getValue = SharedPreferences::getString,
        setValue = Editor::putString,
        block = { it ?: default }
)
...
fun stringOrDefault(key: String, default: String): SharedPreferencesProperty<String> = NullableSharedPreferencesProperty(
        getValue = LegacySharedPreferencesValue(SharedPreferences::getString, Editor::putString, key),
        setValue = Editor::putString,
        block = { it ?: default }
)
...
fun stringOrNull(key: String): SharedPreferencesProperty<String?> = NullableSharedPreferencesProperty(
        getValue = LegacySharedPreferencesValue(SharedPreferences::getString, Editor::putString, key),
        setValue = Editor::putString,
        block = { it }
)

fun stringSetOrDefault(default: Set<String>): SharedPreferencesProperty<Set<String>> = NullableSharedPreferencesProperty(
...
fun stringSetOrDefault(key: String, default: Set<String>): SharedPreferencesProperty<Set<String>> = NullableSharedPreferencesProperty(
